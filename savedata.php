...
<head>
	<meta charset="UTF-8">
	<title>Ajax and php save d requests</title>
</head>
<body>
...
<script>
	...
	function getme(e)
	{
		...
		xhr.open("GET", "formsubmit.php?name2="+document.getElementById('name4').value);
	...
	document.querySelector('#form3').addEventListener('submit',postme);
	function postme(e)
	{
		e.preventDefault();
		var xhr=new XMLHttpRequest();
		...
		xhr.send("name5="+document.getElementById('name5').value);
	}
</script>
</html>